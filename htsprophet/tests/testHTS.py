...
class testHTSOut(unittest.TestCase):
    ...
    def testOutputs(self):
        ...
        ##
        self.assertAlmostEqual(myDict['Total'].yhat[-52:].all(),
                               (myDict['Air'].yhat[-52:] + myDict['Land'].yhat[-52:] + myDict['Sea'].yhat[-52:]).all())
        self.assertAlmostEqual(myDict['Air'].yhat[-52:].all(),
                               (myDict['Air_Stone Tablet'].yhat[-52:] + myDict['Air_Car Phone'].yhat[-52:]).all())
        self.assertAlmostEqual(myDict['Land'].yhat[-52:].all(),
                               (myDict['Land_Stone Tablet'].yhat[-52:] + myDict['Land_Car Phone'].yhat[-52:]).all())
        self.assertAlmostEqual(myDict['Sea'].yhat[-52:].all(),
                               (myDict['Sea_Stone Tablet'].yhat[-52:] + myDict['Sea_Car Phone'].yhat[-52:]).all())
        ##
